...
const routes: RouteObject[] = [
  ...
  // Gate pass — opened at a gate by someone with no account. The token is the
  // only credential, and the page sets a noindex tag on mount.
  {
    path: '/pass/:token',
    element: <Lazy><GatePass /></Lazy>,
  },
